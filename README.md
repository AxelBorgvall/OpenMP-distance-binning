...
## Solutions
This fixed format allowed for optimizing file reading by not searching for and seperating values at spaces, but rather using the known positions of the values in the file to more quickly load chunks of it into memory. The output is printed to the terminal in the format:
03.00 1
